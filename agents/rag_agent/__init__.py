...
class MedicalRAG:
    ...
    def __init__(self, config):
        ...
        try:
            ...
            # Keep RAG available even if external reranker resources are unavailable.
            self.logger.warning(f"Reranker initialization failed, using retrieval-only mode: {e}")
            self.reranker = None
